...
const LoginForm = ({ redirectUrl }) => {
  ...
  return (
    <>
      <form className='m-auto my-16 max-w-[500px] bg-indigo-200 p-8 border-2 shadow-md rounded-md'>
        {loading ? (
          <Loader />
        ) : (
          <>
            ...
            <button className='text-lg font-serif py-2 px-6 cursor-pointer bg-gradient-to-r from-indigo-500 to-purple-500 transition rounded-full' onClick={handleSubmit}>Submit</button>
